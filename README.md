...
Минималистичная ритм-аркада без обязательной музыки. Игрок нажимает в момент совпадения движущегося пульса с центральной зоной, но период пульса постоянно меняется.
