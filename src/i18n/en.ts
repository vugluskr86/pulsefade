...
registerLocale('en', {
  ...
  'shop.category.backgrounds': 'Animated backgrounds',
  'shop.category.targets': 'Targets',
  ...
  'cosmetic.background_reactor.title': 'Reactor',
  'cosmetic.background_reactor.desc': 'Concentric rings and an audio trace',
  'cosmetic.background_portal.title': 'Portal',
  'cosmetic.background_portal.desc': 'Toothed ring, light columns and a neon floor',
  'cosmetic.background_horizon.title': 'Horizon',
  'cosmetic.background_horizon.desc': 'Radar and a receding floor beyond the horizon',
  'cosmetic.background_orbit.title': 'Orbits',
  'cosmetic.background_orbit.desc': 'Eccentric trajectories with running lights',
  'cosmetic.background_tunnel.title': 'Tunnel',
  'cosmetic.background_tunnel.desc': 'Rings flying out of the depth towards you',
  'cosmetic.background_scanner.title': 'Scanner',
  'cosmetic.background_scanner.desc': 'Rotating radar beam and a crosshair',
  'cosmetic.background_frame.title': 'Frame',
  'cosmetic.background_frame.desc': 'Side rails, angled beams and flickering indicators',
  'cosmetic.background_eclipse.title': 'Eclipse',
  'cosmetic.background_eclipse.desc': 'An offset light source and its crescent',
  'cosmetic.background_gates.title': 'Gates',
  'cosmetic.background_gates.desc': 'Two opposing beams and an instrument bar',
  'cosmetic.background_constellation.title': 'Constellation',
  'cosmetic.background_constellation.desc': 'Twinkling lights on concentric orbits',
  'cosmetic.target_crosshair.title': 'Crosshair',
  'cosmetic.target_crosshair.desc': 'Instrument dial with a crosshair and a hot core',
  'cosmetic.target_sectors.title': 'Sectors',
  'cosmetic.target_sectors.desc': 'Wide counter-rotating arcs around the core',
  'cosmetic.target_wander.title': 'Wandering core',
  'cosmetic.target_wander.desc': 'A steady outline with a living core inside it',
  'cosmetic.particles_default.title': 'Pulses',
  'cosmetic.particles_default.desc': 'Soft dust from every hit',
  'cosmetic.particles_spark.title': 'Sparks',
  'cosmetic.particles_spark.desc': 'Fast stretched traces with white cores',
  'cosmetic.particles_rings.title': 'Rings',
  'cosmetic.particles_rings.desc': 'Opening rings and a double wave on PERFECT',
  'cosmetic.particles_void.title': 'Void',
  'cosmetic.particles_void.desc': 'Particles scatter and get pulled back in',
  'cosmetic.sound_default.title': 'Clicks',
  'cosmetic.sound_default.desc': 'Short synthesized clicks',
  'cosmetic.sound_chime.title': 'Chimes',
  'cosmetic.sound_chime.desc': 'Pentatonic chime with a long tail',
  'cosmetic.sound_techno.title': 'Techno',
  'cosmetic.sound_techno.desc': 'Dry click with a falling pitch and sub',
