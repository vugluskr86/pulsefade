...
registerLocale('en', {
  ...
  'cosmetic.background_reactor.desc': 'Pulsing core and concentric rings',
  'cosmetic.background_portal.title': 'Portal',
  'cosmetic.background_portal.desc': 'Deep rings with a slow breath',
  'cosmetic.background_horizon.title': 'Horizon',
  'cosmetic.background_horizon.desc': 'Radar beyond a neon horizon',
  'cosmetic.background_orbit.title': 'Orbits',
  'cosmetic.background_orbit.desc': 'Offset drifting trajectories',
  'cosmetic.background_tunnel.title': 'Tunnel',
  'cosmetic.background_tunnel.desc': 'Accelerating perspective rings',
  'cosmetic.background_scanner.title': 'Scanner',
  'cosmetic.background_scanner.desc': 'Rotating radar slices',
  'cosmetic.background_frame.title': 'Frame',
  'cosmetic.background_frame.desc': 'Flickering HUD frame and corner marks',
  'cosmetic.background_eclipse.title': 'Eclipse',
  'cosmetic.background_eclipse.desc': 'A slow-moving source of light',
  'cosmetic.background_gates.title': 'Gates',
  'cosmetic.background_gates.desc': 'Two opposing neon systems',
  'cosmetic.background_constellation.title': 'Constellation',
  'cosmetic.background_constellation.desc': 'A field of twinkling signals',
  'cosmetic.target_crosshair.title': 'Crosshair',
  'cosmetic.target_crosshair.desc': 'Rotating neon HUD crosshair',
  'cosmetic.target_sectors.title': 'Sectors',
  'cosmetic.target_sectors.desc': 'Several rotating arcs around the target',
  'cosmetic.target_wander.title': 'Wandering core',
  'cosmetic.target_wander.desc': 'A glowing centre moves inside the target',
