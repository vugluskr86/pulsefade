...
registerLocale('ru', {
  ...
  'cosmetic.background_reactor.desc': 'Пульсирующее ядро и концентрические кольца',
  'cosmetic.background_portal.title': 'Портал',
  'cosmetic.background_portal.desc': 'Глубокие кольца с медленным дыханием',
  'cosmetic.background_horizon.title': 'Горизонт',
  'cosmetic.background_horizon.desc': 'Радар за неоновым горизонтом',
  'cosmetic.background_orbit.title': 'Орбиты',
  'cosmetic.background_orbit.desc': 'Смещённые дрейфующие траектории',
  'cosmetic.background_tunnel.title': 'Туннель',
  'cosmetic.background_tunnel.desc': 'Ускоряющиеся кольца перспективы',
  'cosmetic.background_scanner.title': 'Сканер',
  'cosmetic.background_scanner.desc': 'Вращающиеся радарные срезы',
  'cosmetic.background_frame.title': 'Контур',
  'cosmetic.background_frame.desc': 'Мерцающая HUD-рамка и угловые метки',
  'cosmetic.background_eclipse.title': 'Затмение',
  'cosmetic.background_eclipse.desc': 'Медленно проходящий источник света',
  'cosmetic.background_gates.title': 'Врата',
  'cosmetic.background_gates.desc': 'Две встречные неоновые системы',
  'cosmetic.background_constellation.title': 'Созвездие',
  'cosmetic.background_constellation.desc': 'Поле мерцающих сигналов',
  'cosmetic.target_crosshair.title': 'Прицел',
  'cosmetic.target_crosshair.desc': 'Вращающийся неоновый HUD-прицел',
  'cosmetic.target_sectors.title': 'Секторы',
  'cosmetic.target_sectors.desc': 'Несколько вращающихся дуг вокруг цели',
  'cosmetic.target_wander.title': 'Блуждающее ядро',
  'cosmetic.target_wander.desc': 'Светящийся центр движется внутри мишени',
